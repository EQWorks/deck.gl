...
function getTileIndices(viewport, maxZoom, minZoom) {
  ...
  let [minX, minY] = (0, _viewportMercatorProject.lngLatToWorld)([bbox[0], bbox[3]], viewport.scale).map(pixelsToTileIndex);
  let [maxX, maxY] = (0, _viewportMercatorProject.lngLatToWorld)([bbox[2], bbox[1]], viewport.scale).map(pixelsToTileIndex);
